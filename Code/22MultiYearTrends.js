...
var C2007 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2007GDD0"),
    C2008 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2008GDD0"),
    C2009 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2009GDD0"),
    C2010 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2010GDD0"),
    C2011 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2011GDD0"),
    C2012 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2012GDD0"),
    C2013 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2013GDD0"),
    C2014 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2014GDD0"),
    C2015 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2015GDD0"),
    C2016 = ee.Image("users/yz2522/0PlantFreezeCCclassifier"+datestr+"all2016GDD0");
...
var tick = function(i){
  ...
  Export.image.toAsset({
    ...
    assetId: 'CCclassifier'+datestr+'all'+String(year)+'GDD0added',
    scale: 30,
    region: subcount.geometry().bounds(),
...
var Ca2008 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2008GDD0added"),
    Ca2009 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2009GDD0added"),
    Ca2010 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2010GDD0added"),
    Ca2011 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2011GDD0added"),
    Ca2012 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2012GDD0added"),
    Ca2013 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2013GDD0added"),
    Ca2014 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2014GDD0added"),
    Ca2015 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2015GDD0added"),
    Ca2016 = ee.Image("users/yz2522/CCclassifier"+datestr+"all2016GDD0added");
